...
Class.forName("com.mysql.jdbc.Driver");
    	    ...
    	    String sql="select info from data d,sports s where d.d_id=s.id and d.link='"+slink+"'";
...
<h1><%=title%></h1>
<p><font size=""><%=info %></font></p>	
<INPUT TYPE="submit" value="Save" input style=" width:90px;height:50px;font-size:12pt;" >
